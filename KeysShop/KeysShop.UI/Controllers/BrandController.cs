...
namespace KeyShop.UI.Controllers
{
    public class BrandController : Controller
    {
        ...
        public async Task<IActionResult> Create(KeysShop.Core.Brand brand)
        {
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> Edit(KeysShop.Core.Brand brand)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [AutoValidateAntiforgeryToken]
        public async Task<IActionResult> Delete(KeysShop.Core.Brand brand)
        {
